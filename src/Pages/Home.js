  ...
  return (
    <>
      ...
      <div>
        <div className="d-flex justify-content-center">
          ...
          <div>
            <div
              id="guia1"
              style={{ width: '600px', height: '450px', margin: '10px' }}
            ></div>
            <div> </div>
            <div>
        ...
        <div className="d-flex justify-content-center">
          <div>
            <div id="teste" className="d-flex justify-content-center">
              <h5> Oportunidades para guias turisticos</h5>
              <p>
                Se você é um guia turístico experiente e apaixonado por esportes
                radicais, temos uma oportunidade única para você! Estamos em
                busca de profissionais que possam liderar nossos clientes em
                aventuras emocionantes ao redor do mundo.
              </p>
              <div className="container-xl">
                <button className="d-flex justify-content-center">
                  ME INSCREVER
      ...
      <div>
        ...
        <div
          id="logo"
          style={{ width: '668px', height: '750px', margin: '10px' }}
        ></div>
        <div>
          <p>sobre</p>
          ...
          <p>
            ...
            criado para aqueles que buscam adrenalina e aventura em suas férias.
          </p>
          <p>
            Oferecemos uma ampla variedade de opções de atividades emocionantes,
            desde paraquedismo até rafting, para que você possa escolher aquelas
            que mais lhe agradam.
          </p>
          <p>
            Além disso, nosso site permite que você ajuste sua viagem de acordo
            com a região e seu orçamento, para que possa aproveitar ao máximo a
            sua aventura.
          </p>
