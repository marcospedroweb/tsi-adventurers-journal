        ...
        <div className='col-12 col-lg-6 align-self-start d-none d-lg-block'>
          <div className={`${styles.img1} position-relative`}>
            <div className='justify-content-center text-center position-absolute top-50 translate-middle-y bg-white rounded'>
              ...
              <p>   Se você é um guia turístico experiente e apaixonado por esportes radicais, temos uma oportunidade única para você!     Estamos em busca de profissionais que possam liderar nossos clientes em aventuras emocionantes ao redor do mundo.
              </p>
              <ButtonCustom bsClass="text-uppercase">Me inscrever</ButtonCustom>
            </div>
          </div>
        </div>
        {/* MOBILE */}
